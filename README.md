...
<p>The AVL tree removal implementation is similar to the BST one except that you need to add 2 lines of code to ensure that the tree remains balanced and that the bounce factor and height values remain up to date.</p>
